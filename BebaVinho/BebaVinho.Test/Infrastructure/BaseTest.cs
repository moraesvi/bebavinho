...
namespace BebaVinho.Test.Infrastructure
{
    ...
    {
        protected const string ADMIN_NAME_TEST = "Administador Teste";
        protected const string ADMIN_UPDATE_NAME_TEST = "Administador Update";

        protected const string USER_NAME_TEST = "Teste";
        protected const string USER_SURNAME_TEST = "Teste";
        protected const string USER_UPDATE_NAME_TEST = "Teste";
        protected const string USER_UPDATE_SURNAME_TEST = "Update";

        protected const string PRODUCT_NAME = "Teste Produto";
        protected const decimal PRODUCT_PRICE = 100;
        protected const string PRODUCT_DESCRIPTION = "Teste descrição produto";
        //TODO: Definir enumerador contendo os tipos de produto.
        protected const int PRODUCT_TYPE = 1;

        protected const string PRODUCT_UPDATE_NAME = "Teste Update Produto";
        protected const decimal PRODUCT_UPDATE_PRICE = 200;
        protected const string PRODUCT_UPDATE_DESCRIPTION = "Teste update descrição produto";
        //TODO: Definir enumerador contendo os tipos de produto.
